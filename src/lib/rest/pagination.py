...
class CursorPagination[T: BaseModel](AsyncPaginationBase):
    ...
    def paginate_queryset(self, queryset: QuerySet[T], pagination: Any, **params: Any) -> Any:
        pass  # pragma: no cover

    async def apaginate_queryset(self, queryset: QuerySet[T], pagination: Input, **params: Any) -> dict[str, Any]:
